...
/** Experiment 7 - Timer anamoly. Order of execution can never be guaranteed even if you write 0 delay will be considered as 1ms and maybe readFile will be before setTimeout*/
...
// this loop to avoid problem of setTimeout 0 will be placed to 1ms and some time readFile will be before setTimeout but now with this loop we give setTimeout enough time to be sure serTimeout will be before readFile
...
/** Experiment 12 - Microtask queues callbacks are executed inbetween check queue callbacks ( between callbacks in check queue event loop also will go to  Microtask queues) */
